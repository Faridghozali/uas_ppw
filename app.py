...
with Data:
   ...
   st.text("1) Date\n2) Title\n3) Content\n4) Label")
   st.subheader("Data")
   data = pd.read_csv("https://gist.githubusercontent.com/Faridghozali/c8cf2380611400aa5017b3a3c3f804a0/raw/7910efae28615e0c9a333bfe9c1fb298204ce665/data_berita.csv")
   st.write(data)
